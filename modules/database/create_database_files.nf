process CREATE_DATABASE_FILES {
    ...
    output:
    path("${sample_id}_fusion_check.csv")
    ...
    if [[ ! -f sample_results/Results/${sample_id}/${sample_id}_AllFusions.csv ]]; then
        echo "fusion,exons,reference_reads_1,reference_reads_2,fusion_supporting_reads,left_breakpoint,right_breakpoint,type,in_ntc,spanning_reads,spanning_reads_dedup,split_reads,split_reads_dedup,fusion_caller,fusion_score" > ./Gathered_Results/Database/${sample_id}_fusion_check.csv
